...
c
      ...
      if (use_mpole .or. use_polar)  call empole1_cp
         else
      if (use_mpole .or. use_polar)  call empole1
        end if
      if (use_rxnfld)  call erxnfld1
      if (use_chargetranfer)  call empole1_ct
c
...
c      print*,"Ep_ct=",ep_ct
     ...
     &                      + dex(j,i) + dep_ct(j,i)
      ...
      do i=1,n
c         print*,"dep_x",i,dep(1,i) ,dep_ct(1,i)
c         print*,"dep_y",i,dep(2,i) ,dep_ct(2,i)
c         print*,"dep_z",i,dep(3,i) ,dep_ct(3,i)
      end do
c
