...
c
      ...
      if (allocated(aep_ct))  deallocate (aep_ct)
...
c
      ...
      if (allocated(dep_ct))  deallocate (dep_ct)
...
c      if (allocated(mindex_ct))  deallocate (mindex_ct)
c      if (allocated(minv_ct))  deallocate (minv_ct)
c
