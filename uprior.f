...
c
      ...
      character*4 polpred
      integer maxualt_ct
      parameter (maxualt_ct=7)
      integer nualt_ct
      real*8 gear_ct(maxualt_ct)
      real*8 aspc_ct(maxualt_ct)
      real*8 bpred_ct(maxualt_ct)
      real*8 bpredp_ct(maxualt_ct)
      real*8 bpreds_ct(maxualt_ct)
      real*8 bpredps_ct(maxualt_ct)
      real*8, allocatable :: udalt_ct(:,:,:)
      real*8, allocatable :: upalt_ct(:,:,:)
      real*8, allocatable :: usalt_ct(:,:,:)
      real*8, allocatable :: upsalt_ct(:,:,:)
      logical use_pred_ct
      character*4 polpred_ct
      save
      end
