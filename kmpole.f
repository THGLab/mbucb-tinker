...
c
      ...
      if (allocated(ipole_ct))  deallocate (ipole_ct)
...
c
      do i = 1, n
         do k = 2, 4
            if(i.eq.3) then
               if(k.eq.2) then
c                 print*,"d_x=",pole(k,i)
               else if(k.eq.3) then
c                 print*,"d_y=",pole(k,i)
               else if(k.eq.4) then
c                 print*,"d_z=",pole(k,i)
               end if
            end if
         ...
         do k = 5, 13
            if(i.eq.3) then
               if(k.eq.5) then
c                 print*,"q_xx=",pole(k,i)
               else if(k.eq.6) then
c                 print*,"q_xy=",pole(k,i)
               else if(k.eq.7) then
c                 print*,"q_xz=",pole(k,i)
               else if(k.eq.8) then
c                 print*,"q_yx=",pole(k,i)
               else if(k.eq.9) then
c                 print*,"q_yy=",pole(k,i)
               else if(k.eq.10) then
c                 print*,"q_yz=",pole(k,i)
               else if(k.eq.11) then
c                 print*,"q_zx=",pole(k,i)
               else if(k.eq.12) then
c                 print*,"q_zy=",pole(k,i)
               else if(k.eq.13) then
c                 print*,"q_zz=",pole(k,i)
               end if
            end if
...
c
c      if (.not.use_polar .and. .not.use_solv) then
      if (.not. use_polar .or. .not. use_chargetranfer 
     &         .and. .not.use_solv) then
         npole = 0
         do i = 1, n
