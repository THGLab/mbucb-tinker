...
c
      ...
      real*8 ep0,er0,es0,elf0,eg0,ex0,ep_ct0
...
!               write (iout,*)'debugg testt',etot,detot
         end if
c
...
c
  ...
  150          format (/,'  Energy',7x,'EB',14x,'EA',14x,'EBA',
     ...
     &                           ed,em,ep,er,es,elf,eg,ex,ep_ct
  160          format (/,6x,4f16.8,/,6x,4f16.8,/,6x,4f16.8,/,6x,4f16.8,
     &                 /,6x,4f16.8,/,6x,4f16.8,/,6x,f16.8,6x,f16.8)
            else if (digits .ge. 6) then
               write (iout,170)
...
c akd
c      do i=1,n
c           write (*,*)i,'dem anal',dem(1,i),dem(2,i),dem(3,i)
c      end do
c      do i=1,n
c           write (*,*)'dep_x num',i,ndep(1,i),'dep_x anal',dep(1,i)   
c           write (*,*)'dep_y num',i,ndep(2,i),'dep_y anal',dep(2,i)   
c           write (*,*)'dep_z num',i,ndep(3,i),'dep_z anal',dep(3,i)   
c           write (*,*)i,'dep anal',dep(1,i),dep(2,i),dep(3,i)   
c      end do
c      do i=1,n
c      write (*,*)'dep_ct_xnum',i,ndep_ct(1,i),'dep_ct_xanal',dep_ct(1,i)
c      write (*,*)'dep_ct_ynum',i,ndep_ct(2,i),'dep_ct_yanal',dep_ct(2,i)
c      write (*,*)'dep_ct_znum',i,ndep_ct(3,i),'dep_ct_zanal',dep_ct(3,i)
c      write (*,*)i,'dep_ct anal',dep_ct(1,i),dep_ct(2,i),dep_ct(3,i)
c      end do
c      do i=1,n
c           write (*,*)i,'tot anal',detot(1,i),detot(2,i),detot(3,i)
c      end do

c           write (*,273)
c  273     format('Atom',2x,'dep_diff_x',2x,'dep_diff_y',2x,'dep_diff_z')
c   
c      do i=1,n
c           write (*,275)i,(dep(j,i)-ndep(j,i), j=1,3)
c      end do
c  275     format(i2,2x,3(f13.10,2x))
