...
c
     ...
     &          11x,''Kcal/mole'',6x,''Interactions''/)'
      ...
      if (use_vdw .and. (nev.ne.0.or.ev.ne.0.0d0)) then
         ...
         if (abs(ev_rep) .lt. 1.0d10) then
            fstr = '('' VdW Repulsive'',14x,'//form1//')'
         else
            fstr = '('' VdW Repulsive'',14x,'//form2//')'
         end if
         write (iout,fstr)  ev_rep,nev

           fstr = '('' VdW Attractve'',14x,'//form1//')'
         write (iout,fstr)  ev_attr,nev
      end if
      ...
      if (use_polar .and. (nep.ne.0.or.ep_ct.ne.0.0d0)) then
         if (abs(ep_ct) .lt. 1.0d10) then
            fstr = '('' Charge Transfer  '',10x,'//form1//')'
         else
            fstr = '('' Charge Transfer  '',10x,'//form2//')'
         end if
         write (iout,fstr)  ep_ct,nep
      end if
...
c         write(*,*)'dE/dV Virial',
c     &           (vir(1,1)+vir(2,2)+vir(3,3)) / (3.0d0*volbox)
c
