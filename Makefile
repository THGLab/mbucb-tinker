...
#OLDALBAUGHDIR = /home/akdas/tinker8.2.1/fftw/lib
#NEWALBAUGHDIR = /home/akdas/tinker8.2.1/fftw/lib

## SPANISH ARMADA 1588
#F77 = ifort
#LIBS = -L$(NEWALBAUGHDIR) -lfftw3_threads -lfftw3
#F77FLAGS = -c -xHost
#OPTFLAGS = -O3 -no-ipo -no-prec-div -recursive -openmp
#LIBFLAGS = -crusv
#RANLIB = ranlib -c
...
#F77 = ifort
#LIBS = -L/global/home/users/hh8/software/Tinker7_efield_v2/fftw/lib -lfftw3_threads -lfftw3
#F77FLAGS = -c -xHost
...
OBJS = action.o \
       ...
       induce_ct.o \
       induce_ct_akd.o \
       induce_aniso_invert_test.o \
       aniso.o \
       chargetransfer.o \
       induce_aniso_invert.o \
       dfield0a_mut_tensor.o \
       ehal3a_attr_rep.o \
       active.o \
       alchemy.o \
       align.o \
...
###############################################################
induce_aniso_akd.o: atoms.o bound.o boxes.o cell.o couple.o ewald.o gkstuf.o group.o inform.o iounit.o limits.o math.o mpole.o neigh.o openmp.o pbstuf.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o solute.o tarray.o units.o uprior.o usolve.o polar_aniso.o penetrate.o
induce_ct.o: atoms.o bound.o boxes.o cell.o couple.o ewald.o gkstuf.o group.o inform.o iounit.o limits.o math.o mpole.o neigh.o openmp.o pbstuf.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o solute.o tarray.o units.o uprior.o usolve.o chargetransfer.o
induce_ct_akd.o: atoms.o bound.o boxes.o cell.o couple.o ewald.o gkstuf.o group.o inform.o iounit.o limits.o math.o mpole.o neigh.o openmp.o pbstuf.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o solute.o tarray.o units.o uprior.o usolve.o chargetransfer.o polar_aniso.o
induce_aniso_invert_test.o: atoms.o bound.o boxes.o cell.o couple.o ewald.o gkstuf.o group.o inform.o iounit.o limits.o math.o mpole.o neigh.o openmp.o pbstuf.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o solute.o tarray.o units.o uprior.o usolve.o polar_aniso.o
aniso.o: kpolr_aniso.o atoms.o bound.o hescut.o keys.o limits.o neigh.o polpot.o sizes.o tarray.o
polar_aniso.o:
kpolr_aniso.o:
chargetransfer.o:
mod_chgpen.o:
chgpen.o: mod_chgpen.o
induce_aniso_invert.o: atoms.o bound.o boxes.o cell.o couple.o ewald.o gkstuf.o group.o inform.o iounit.o limits.o math.o mpole.o neigh.o openmp.o pbstuf.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o solute.o tarray.o units.o uprior.o usolve.o polar_aniso.o
dfield0a_mut_tensor.o: atoms.o bound.o boxes.o cell.o couple.o ewald.o gkstuf.o group.o inform.o iounit.o limits.o math.o mpole.o neigh.o openmp.o pbstuf.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o solute.o tarray.o units.o uprior.o usolve.o polar_aniso.o iounit.o
action.o:
...
charge.o:
chgpot.o:
chkpole.o: atoms.o mpole.o sizes.o polar_aniso.o kpolr_aniso.o
chkring.o: couple.o
...
ehal3a_attr_rep.o: action.o analyz.o atomid.o atoms.o bound.o boxes.o cell.o couple.o energi.o group.o inform.o inter.o iounit.o light.o limits.o molcul.o mutant.o neigh.o shunt.o sizes.o usage.o vdw.o vdwpot.o energi_hal.o
...
empole1_ct.o: atoms.o bound.o boxes.o cell.o chgpot.o couple.o deriv.o energi.o ewald.o group.o inter.o limits.o math.o molcul.o mplpot.o mpole.o neigh.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o virial.o chargetransfer.o
empole1_cp.o: atoms.o bound.o boxes.o cell.o chgpot.o couple.o deriv.o energi.o ewald.o group.o inter.o limits.o math.o molcul.o mplpot.o mpole.o neigh.o pme.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o virial.o mod_chgpen.o
...
empole2_cp.o: atoms.o bound.o boxes.o chgpot.o couple.o group.o hessn.o limits.o molcul.o mplpot.o mpole.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o kpolr_aniso.o mod_chgpen.o
empole2_ct.o: atoms.o bound.o boxes.o chgpot.o couple.o group.o hessn.o limits.o molcul.o mplpot.o mpole.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o chargetransfer.o kpolr_aniso.o
empole3.o: action.o analyz.o atomid.o atoms.o bound.o boxes.o cell.o chgpot.o couple.o energi.o ewald.o group.o inform.o inter.o iounit.o limits.o math.o molcul.o mplpot.o mpole.o neigh.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o kpolr_aniso.o iounit.o penetrate.o chargetransfer.o
empole3_ct.o: action.o analyz.o atomid.o atoms.o bound.o boxes.o cell.o chgpot.o couple.o energi.o ewald.o group.o inform.o inter.o iounit.o limits.o math.o molcul.o mplpot.o mpole.o neigh.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o kpolr_aniso.o iounit.o penetrate.o chargetransfer.o
empole3_pen.o: action.o analyz.o atomid.o atoms.o bound.o boxes.o cell.o chgpot.o couple.o energi.o ewald.o group.o inform.o inter.o iounit.o limits.o math.o molcul.o mplpot.o mpole.o neigh.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o kpolr_aniso.o iounit.o penetrate.o chargetransfer.o
empole3_cp.o: action.o analyz.o atomid.o atoms.o bound.o boxes.o cell.o chgpot.o couple.o energi.o ewald.o group.o inform.o inter.o iounit.o limits.o math.o molcul.o mplpot.o mpole.o neigh.o polar.o polgrp.o polpot.o potent.o shunt.o sizes.o usage.o kpolr_aniso.o iounit.o penetrate.o chargetransfer.o mod_chgpen.o
energi.o:
...
kitors.o:
kmetal.o:
kmpole.o: atoms.o couple.o inform.o iounit.o keys.o kmulti.o mpole.o polar.o polgrp.o potent.o sizes.o units.o chargetransfer.o
kmulti.o:
...
kpolar.o: atoms.o couple.o inform.o iounit.o keys.o kpolr.o mpole.o polar.o polgrp.o polpot.o potent.o sizes.o usolve.o kpolr_aniso.o polar_aniso.o penetrate.o chargetransfer.o mod_chgpen.o
kpolr.o: sizes.o
...
prmkey.o: angpot.o bndpot.o chgpot.o fields.o mplpot.o polpot.o potent.o rxnpot.o torpot.o urypot.o vdwpot.o mod_chgpen.o
promo.o: iounit.o
...
readprm.o: fields.o iounit.o kanang.o kangs.o kantor.o katoms.o kbonds.o kchrge.o kdipol.o khbond.o kiprop.o kitors.o kmulti.o kopbnd.o kopdst.o korbs.o kpitor.o kpolr.o kstbnd.o ksttor.o ktorsn.o ktrtor.o kurybr.o kvdwpr.o kvdws.o merck.o params.o sizes.o kpolr_aniso.o penetrate.o chargetransfer.o mod_chgpen.o 
...
rotpole.o: atoms.o mpole.o sizes.o polar_aniso.o kpolr_aniso.o
rxnfld.o:
rxnpot.o:
...
torque_ct.o: atoms.o deriv.o mpole.o sizes.o
tors.o:
