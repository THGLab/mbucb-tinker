...
c
      if (polaxe(i) .eq. 'Z-Only') then
         print*,i,"Atom ",name(i)," Polaxe ",polaxe(i)
         print*,i,"Atom ",name(i),ix," Atom X-axis ",name(ix)
         print*,i,"Atom ",name(i),iy," Atom Y-axis ",name(iy)
         print*,i,"Atom ",name(i),iz," Atom Z-axis ",name(iz)
         dx = x(iz) - xi
         dy = y(iz) - yi
         dz = z(iz) - zi
