...
! qtw >> in
            ...
            read (string,*,err=1135,end=1135) ia,n_valence,a_jp,b_jp
            write(*,*)"n_val =", n_valence
            write(*,*)"a_jp =", a_jp
            write(*,*)"b_jp =", b_jp
 1135       continue
            write (iprm,1136) ia,n_valence,a_jp,b_jp
 1136       format ('chgpenprm',2x,i5,5x,i10,2x,f11.4,2x,f11.4)
! qtw >> out
...
! qtw >> in
            ...
            ! read type N_val_JP alpha_JP beta_JP
            read (string,*,err=425,end=425) ia,n_valence,a_jp,b_jp
            write(*,*)"n_val =", n_valence
            write(*,*)"a_jp =", a_jp
            write(*,*)"b_jp =", b_jp
  425       continue
            ia = itype(ia)
            write (iprm,426) ia,n_valence,a_jp,b_jp
  426       format ('chgpenprm',2x,i5,5x,i10,2x,f11.4,2x,f11.4)
! qtw >> out
