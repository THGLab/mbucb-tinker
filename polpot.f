...
c
      ...
      character*6 poltyp
      integer politer_ct
      real*8 poleps_ct,p2scale_ct
      real*8 p3scale_ct,p4scale_ct
      real*8 p5scale_ct,p41scale_ct
      real*8 d1scale_ct,d2scale_ct
      real*8 d3scale_ct,d4scale_ct
      real*8 u1scale_ct,u2scale_ct
      real*8 u3scale_ct,u4scale_ct
      real*8 udiag_ct
      save
      end
